...
in vec3 f_lightPoint;

void main(void)
{
	vec3 light = f_lightPoint; // Given in VIEW coordinates! You usually specify light sources in world coordinates.
	...
	outColor = vec4(2*shade, shade, shade, 1.0);
}

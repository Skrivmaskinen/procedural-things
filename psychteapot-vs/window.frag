...
void main(void)
{
    const vec3 light = 1.2*vec3(0.58, 0.58, 0.58); // Given in VIEW coordinates! You usually specify light sources in world coordinates.
    ...
    //outColor = vec4(0.5*diffuse, 0.2, 0.5*diffuse, 1.0);
    outColor = myPosition;
}
